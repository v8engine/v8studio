package com.v8en.studio.controller.system.login;
...
import com.v8en.studio.controller.base.BaseController;
import com.v8en.studio.entity.system.Role;
import com.v8en.studio.service.system.appuser.AppuserManager;
import com.v8en.studio.service.system.buttonrights.ButtonrightsManager;
import com.v8en.studio.service.system.button.FhbuttonManager;
import com.v8en.studio.service.system.loginimg.LogInImgManager;
import com.v8en.studio.service.system.menu.MenuManager;
import com.v8en.studio.service.system.role.RoleManager;
import com.v8en.studio.service.system.user.UserManager;
import com.v8en.studio.util.AppUtil;
import com.v8en.studio.util.RightsHelper;
...
import com.v8en.studio.service.system.log.FHlogManager;
import com.v8en.studio.entity.system.Menu;
import com.v8en.studio.entity.system.User;
import com.v8en.studio.util.Const;
import com.v8en.studio.util.DateUtil;
import com.v8en.studio.util.Jurisdiction;
import com.v8en.studio.util.PageData;
import com.v8en.studio.util.Tools;
/**
 * 总入口
 * @author Simon
 * 修改日期：2015/11/2
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq582883825v8", "").replaceAll("QQ978336446fh", "").split(",fh,");
